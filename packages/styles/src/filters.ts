 ...
 */
export function all(...filters: ExpressionFilterSpecification[]): ExpressionFilterSpecification {
...
export function scaleFilter({ tilesize = 512 } = {}): ExpressionFilterSpecification {
...
export function attributeFilters(conditions: { attl: string; attv?: string; }[]): ExpressionFilterSpecification[] {
