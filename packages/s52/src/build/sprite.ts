import fs from 'fs';
import sprite from "../../sprites/day.json" with { type: "json" };
import sprite2x from "../../sprites/day@2x.json" with { type: "json" };
...
@media (-webkit-min-device-pixel-ratio: 2), (min-resolution: 192dpi) {
  .symbol,
  .symbol.day {
    background-image: url("./day@2x.png");
    background-size: ${width / 2}px ${height / 2}px;
  }
  .symbol.dusk {
    background-image: url("./dusk@2x.png");
  }
  .symbol.night {
    background-image: url("./night@2x.png");
  }
